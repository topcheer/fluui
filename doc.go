...
//
// Fluui provides a complete terminal UI framework with 135 components, 64 terminal
// protocols, 100% zero-allocation rendering (all 44 Paint benchmarks), and first-class
// AI chat support.
//
// # Quick Start
//
