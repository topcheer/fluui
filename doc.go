...
//
// Fluui provides a complete terminal UI framework with 120 components, 25 terminal
// protocols, 100% zero-allocation rendering (all 42 Paint benchmarks), and first-class
// AI chat support.
//
// # Quick Start
//
